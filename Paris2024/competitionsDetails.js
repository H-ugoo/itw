...
var vm = function () {
    ...
    var self = this;
    self.baseUri = ko.observable('http://192.168.160.58/Paris2024/API/competitions'); // Defina a URI base da API
    ...
    // Função para ativar a página e buscar detalhes
    ...
    function ajaxHelper(uri, method, data) {
        self.error(''); // Limpa a mensagem de erro
        return $.ajax({
            type: method,
            url: uri,
            dataType: 'json',
